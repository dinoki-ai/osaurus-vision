...
```json
{
  "plugin_id": "dev.example.osaurus-vision",
  "name": "Osaurus Vision",
  "version": "0.1.0",
  "secrets": [
    {
...
```bash
# Package the plugin
osaurus tools package dev.example.osaurus-vision 0.1.0

# Install locally
osaurus tools install ./dev.example.osaurus-vision-0.1.0.zip
...
```bash
swift build -c release && osaurus tools package dev.example.osaurus-vision 0.1.0 && osaurus tools install ./dev.example.osaurus-vision-0.1.0.zip
```
